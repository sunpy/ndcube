...
PACKAGENAME = metadata.get('package_name', 'ndcube')
DESCRIPTION = metadata.get('description', 'A base package for multi-dimensional contiguious and non-contiguious spatially aware arrays.')
...
setup(name=PACKAGENAME,
      ...
      scripts=scripts,
      install_requires=metadata['install_requires'].strip().split(),
      author=AUTHOR,
