...
class NDCubeBase(NDCubeSlicingMixin, NDCubeABC):
    ...
    def crop(self, lower_corner, upper_corner, wcs=None):
        ...
        points = self._bounding_box_to_points(lower_corner_values, upper_corner_values,
    ...
    def crop_by_values(self, lower_corner, upper_corner, units=None, wcs=None):
        ...
        points = self._bounding_box_to_points(lower_corner, upper_corner,
                                              wcs.axis_correlation_matrix)
        return self._crop_from_points(*points, wcs=wcs)
    ...
    def _bounding_box_to_points(self, lower_corner_values, upper_corner_values,
