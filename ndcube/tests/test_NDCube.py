...
cube = NDCube(data, wt, mask=mask_cube, uncertainty=np.sqrt(data),
...
@pytest.mark.parametrize("test_input,expected,mask,wcs,uncertainty,dimensions,extra_coords", [
    (cubem[:, 1], NDCube, mask_cubem[:, 1],
     ...
     {'bye': {'axis': 1, 'value': u.Quantity(range(int(cubem.dimensions.shape[2].value)), unit=u.pix)},
      'hello': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'time': {'axis': 0, 'value': u.Quantity(range(int(cubem.dimensions.shape[0].value)), unit=u.pix)}}),
    (cubem[:, 0:2], NDCube, mask_cubem[:, 0:2],
     ...
     {'bye': {'axis': 2, 'value': u.Quantity(range(int(cubem.dimensions.shape[2].value)), unit=u.pix)},
    ...
    (cubem[:, :], NDCube, mask_cubem[:, :],
     ...
     DimensionPair(shape=u.Quantity((2, 3, 4), unit=u.pix),
                   axis_types=['HPLN-TAN', 'HPLT-TAN', 'WAVE']),
     {'time': {'axis': 0, 'value': u.Quantity(range(int(cubem.dimensions.shape[0].value)), unit=u.pix)},
      'hello': {'axis': 1, 'value': u.Quantity(range(int(cubem.dimensions.shape[1].value)), unit=u.pix)},
      'bye': {'axis': 2, 'value': u.Quantity(range(int(cubem.dimensions.shape[2].value)), unit=u.pix)}}),
    (cubem[1, 1], NDCube, mask_cubem[1, 1],
     ...
     {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'hello': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'bye': {'axis': 0, 'value': u.Quantity(range(int(cubem.dimensions.shape[2].value)), unit=u.pix)}}),
    ...
    (cubem[1, :], NDCube, mask_cubem[1, :],
     ...
     {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'hello': {'axis': 0, 'value': u.Quantity(range(int(cubem.dimensions.shape[1].value)), unit=u.pix)},
      'bye': {'axis': 1, 'value': u.Quantity(range(int(cubem.dimensions.shape[2].value)), unit=u.pix)}}),
    (cube[:, 1], NDCube, mask_cube[:, 1],
     _wcs_slicer(wt, [True, False, False, False], (slice(None, None, None), 1)), np.array([2, 3]),
     DimensionPair(shape=u.Quantity((2, 4), unit=u.pix), axis_types=['HPLT-TAN', 'TIME']),
     {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions.shape[1].value)), unit=u.pix)},
      'hello': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'bye': {'axis': 1, 'value': u.Quantity(range(int(cube.dimensions.shape[2].value)), unit=u.pix)}}),
    (cube[:, 0:2], NDCube, mask_cube[:, 0:2],
     ...
     {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions.shape[0].value)), unit=u.pix)},
      'hello': {'axis': 1, 'value': u.Quantity(range(2), unit=u.pix)},
      'bye': {'axis': 2, 'value': u.Quantity(range(int(cube.dimensions.shape[2].value)), unit=u.pix)}}),
    (cube[:, :], NDCube, mask_cube[:, :],
     ...
     DimensionPair(shape=u.Quantity((2, 3, 4), unit=u.pix),
                   axis_types=['HPLT-TAN', 'WAVE', 'TIME']),
     {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions.shape[0].value)), unit=u.pix)},
      'hello': {'axis': 1, 'value': u.Quantity(range(int(cube.dimensions.shape[1].value)), unit=u.pix)},
      'bye': {'axis': 2, 'value': u.Quantity(range(int(cube.dimensions.shape[2].value)), unit=u.pix)}}),
    (cube[1, 1], NDCube, mask_cube[1, 1],
     _wcs_slicer(wt, [True, False, False, False], (1, 1)), np.array([2, 3]),
     DimensionPair(shape=u.Quantity((4,), unit=u.pix), axis_types=['TIME']),
     {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'hello': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'bye': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions.shape[2].value)), unit=u.pix)}}),
    (cube[1, 0:2], NDCube, mask_cube[1, 0:2],
     _wcs_slicer(wt, [True, False, False, False], (1, slice(0, 2, None))), np.array([2, 3]),
    ...
    (cube[1, :], NDCube, mask_cube[1, :],
     ...
     {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'hello': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions.shape[1].value)), unit=u.pix)},
      'bye': {'axis': 1, 'value': u.Quantity(range(int(cube.dimensions.shape[2].value)), unit=u.pix)}}),
])
...
@pytest.mark.parametrize("test_input,expected,mask,wcs,uncertainty,dimensions,extra_coords", [
    ...
    (cubem[1, :, 1], NDCube, mask_cubem[1, :, 1],
     ...
     {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
      'hello': {'axis': 0, 'value': u.Quantity(range(int(cubem.dimensions.shape[1].value)), unit=u.pix)},
      'bye': {'axis': 1, 'value': u.Quantity(1, unit=u.pix)}}),
    (cubem[1, :, 0:2], NDCube, mask_cubem[1, :, 0:2],
    ...
    (cube[1, 1, 0:2], NDCube, mask_cube[1, 1, 0:2],
     ...
     {'time': {'axis': 0, 'value': u.Quantity(1, unit=u.pix)},
...
@pytest.mark.parametrize("test_input,expected", [
    (cubem[1].pixel_to_world([u.Quantity(np.arange(4), unit=u.pix),
     ...
     wm.all_pix2world(u.Quantity(np.arange(4), unit=u.pix), u.Quantity(np.arange(4), unit=u.pix),
                      wm.wcs.crpix[2]-1, 0)[-2]),
    (cubem[1].pixel_to_world([u.Quantity(np.arange(4), unit=u.pix),
                              u.Quantity(np.arange(4), unit=u.pix)])[1],
     wm.all_pix2world(u.Quantity(np.arange(4), unit=u.pix), u.Quantity(np.arange(4), unit=u.pix),
                      wm.wcs.crpix[2]-1, 0)[0]),
    ...
    (cube[1].pixel_to_world([u.Quantity(np.arange(4), unit=u.pix),
                             u.Quantity(np.arange(4), unit=u.pix)])[0],
     wt.all_pix2world(u.Quantity(np.arange(4), unit=u.pix), u.Quantity(np.arange(4), unit=u.pix),
...
@pytest.mark.parametrize("test_input,expected", [
    (cubem[1].world_to_pixel([u.Quantity(np.arange(4), unit=u.deg),
     ...
     wm.all_world2pix(u.Quantity(np.arange(4), unit=u.deg), u.Quantity(np.arange(4), unit=u.m),
                      wm.wcs.crpix[2]-1, 1)[1]),
    (cubem[1].world_to_pixel([u.Quantity(np.arange(4), unit=u.deg),
    ...
    (cubem[0:2].world_to_pixel([u.Quantity(np.arange(4), unit=u.deg),
     ...
     wm.all_world2pix(u.Quantity(np.arange(4), unit=u.deg), u.Quantity(np.arange(4), unit=u.deg),
    ...
    (cube[1].world_to_pixel([u.Quantity(np.arange(4), unit=u.m),
     ...
     wt.all_world2pix(u.Quantity(np.arange(4), unit=u.m), u.Quantity(np.arange(4), unit=u.min),
                      wt.wcs.crpix[2]-1, wt.wcs.crpix[3]-1, 0)[1]),
    (cube[1].world_to_pixel([u.Quantity(np.arange(4), unit=u.m),
    ...
    (cube[0:2].world_to_pixel([u.Quantity(np.arange(4), unit=u.deg),
                               ...
                               u.Quantity(np.arange(4), unit=u.min)])[0],
     wt.all_world2pix(u.Quantity(np.arange(4), unit=u.deg), u.Quantity(np.arange(4), unit=u.m),
