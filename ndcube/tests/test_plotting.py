...
cube_none_axis_ranges_axis2_bye[2] = cube._extra_coords_wcs_axis["bye"]["value"].value
...
@pytest.mark.parametrize("test_input, test_kwargs, expected_values", [
    ...
    (cube_unit[0, 0], {"axes_coordinates": "bye", "axes_units": "km", "data_unit": u.erg},
     (np.ma.masked_array(cube_unit[0, 0]._extra_coords_wcs_axis["bye"]["value"].to(u.km).value,
                         cube_unit[0, 0].mask),
