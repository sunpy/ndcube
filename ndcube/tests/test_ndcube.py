...
@pytest.mark.parametrize("test_input,expected,mask,wcs,uncertainty,dimensions,world_axis_physical_types,extra_coords",
    [(cubem[:, 1],
     ...
     (cube[:, 0:2], # 8th
      NDCube,
      mask_cube[:, 0:2],
      _wcs_slicer(wt, [False, False, False], (slice(None, None, None), slice(0, 2, None))),
      uncertainty[:, 0:2],
      u.Quantity((2, 2, 4), unit=u.pix),
     ...
     (cube[0, 1],
      NDCube,
      mask_cube[1, 1],
      _wcs_slicer(wt, [False, False, False], (0, 1)),
      uncertainty[1, 1],
      u.Quantity((4, ), unit=u.pix),
      tuple(['time']),
      {'time': {'axis': None, 'value': u.Quantity(0., unit=u.pix)},
       'hello': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 0:2],
      NDCube,
      mask_cube[1, 0:2],
      _wcs_slicer(wt, [False, False, False], (1, slice(0, 2, None))),
      uncertainty[1, 0:2],
      u.Quantity((2, 4), unit=u.pix),
      ('em.wl', 'time'),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
...
@pytest.mark.parametrize(
    ...
    [(cubem[1],
     ...
     (cube[:],
      NDCube,
      mask_cube[:],
      _wcs_slicer(wt, [False, False, False], slice(None, None, None)),
      uncertainty[:],
      u.Quantity((2, 3, 4), unit=u.pix),
      ('custom:pos.helioprojective.lat', 'em.wl', 'time'),
      {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions[0].value)), unit=u.pix)},
...
@pytest.mark.parametrize(
    ...
    [(cubem[:, :, 1],  #1
     ...
     (cube[:, 1, 1],  #16
      NDCube,
      mask_cube[:, 1, 1],
      _wcs_slicer(wt, [False, False, False], (slice(None, None, None), 1, 1)),
      uncertainty[:, 1, 1],
      u.Quantity((2, ), unit=u.pix),
      tuple(['custom:pos.helioprojective.lat']),
      {'time': {'axis': None, 'value': u.Quantity(0.8, unit=u.min)},
     ...
     (cube[:, 1, 0:2],  #17
      NDCube,
      mask_cube[:, 1, 0:2],
      _wcs_slicer(wt, [False, False, False], (slice(None, None, None), 1, slice(0, 2, None))),
      uncertainty[:, 1, 0:2],
      u.Quantity((2, 2), unit=u.pix),
      ('custom:pos.helioprojective.lat', 'time'),
      {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions[0].value)), unit=u.pix)},
     ...
     (cube[1, :, 1],  #19
      NDCube,
      mask_cube[1, :, 1],
      _wcs_slicer(wt, [False, False, False], (1, slice(None, None, None), 1)),
      uncertainty[1, :, 1],
      u.Quantity((3, ), unit=u.pix),
      tuple(['em.wl']),
      {'time': {'axis': None, 'value': u.Quantity(0.8, unit=u.min)},
     ...
     (cube[1, :, 0:2],  #20
      NDCube,
      mask_cube[1, :, 0:2],
      _wcs_slicer(wt, [False, False, False], (1, slice(None, None, None), slice(0, 2, None))),
      uncertainty[1, :, 0:2],
      u.Quantity((3, 2), unit=u.pix),
      ('em.wl', 'time'),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 1, 1],  #22
      NDCube,
      mask_cube[1, 1, 1],
      _wcs_slicer(wt, [False, False, False], (1, 1, 1)),
      uncertainty[1, 1, 1],
      u.Quantity((), unit=u.pix),
      (),
      {'time': {'axis': None, 'value': u.Quantity(0.8, unit=u.min)},
     ...
     (cube[1, 1, 0:2],  #23
      NDCube,
      mask_cube[1, 1, 0:2],
      _wcs_slicer(wt, [False, False, False], (1, 1, slice(0, 2, None))),
      uncertainty[1, 1, 0:2],
      u.Quantity((2, ), unit=u.pix),
      tuple(['time']),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 1, :],  #24
      NDCube,
      mask_cube[1, 1, :],
      _wcs_slicer(wt, [False, False, False], (0, 1, 1)),
      uncertainty[1, 1, :],
      u.Quantity((4, ), unit=u.pix),
      tuple(['time']),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
