...
@pytest.mark.parametrize(
    ...
    [
     (cubem[:, 1],
      NDCube,
      mask_cubem[:, 1],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), 1, slice(None, None, None))),
      data[:, 1],
     ...
     (cubem[:, 0:2],
      NDCube,
      mask_cubem[:, 0:2],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), slice(0, 2, None), slice(None, None, None))),
      data[:, 0:2],
     ...
     (cubem[:, :],
      NDCube,
      mask_cubem[:, :],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), slice(None, None, None), slice(None, None, None))),
      data[:, :],
     ...
     (cubem[1, 0:2],
      NDCube,
      mask_cubem[1, 0:2],
      SlicedLowLevelWCS(cubem.wcs, (1, slice(0, 2, None), slice(None, None, None))),
      data[1, 0:2],
      u.Quantity((2, 4), unit=u.pix),
     ...
     (cube[:, 1],
      NDCube,
      mask_cube[:, 1],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), 1, slice(None, None, None), slice(None, None, None))),
      uncertainty[:, 1],
     ...
     (cube[:, 0:2],
      NDCube,
      mask_cube[:, 0:2],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), slice(0, 2, None), slice(None, None, None), slice(None, None, None))),
      uncertainty[:, 0:2],
     ...
     (cube[:, :],
      NDCube,
      mask_cube[:, :],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), slice(None, None, None), slice(None, None, None), slice(None, None, None))),
      uncertainty[:, :],
      u.Quantity((5, 2, 3, 4), unit=u.pix),
      ('custom:pos.helioprojective.lat', 'em.wl', 'time'),
      {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions[0].value)), unit=u.pix)},
     ...
     (cube[1, 1],
      NDCube,
      mask_cube[1, 1],
      SlicedLowLevelWCS(cube.wcs, (1, 1, slice(None, None, None), slice(None, None, None))),
      uncertainty[1, 1],
      u.Quantity((3, 4), unit=u.pix),
      tuple(['time']),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 0:2],
      NDCube,
      mask_cube[1, 0:2],
      SlicedLowLevelWCS(cube.wcs, (1, slice(0, 2, None), slice(None, None, None), slice(None, None, None))),
      uncertainty[1, 0:2],
      u.Quantity((2, 3, 4), unit=u.pix),
      ('em.wl', 'time'),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, :],
      NDCube,
      mask_cube[1, :],
      SlicedLowLevelWCS(cube.wcs, (1, slice(None, None, None),
...
@pytest.mark.parametrize(
    ...
    [(cubem[1],
     ...
     (cubem[0:2],
      NDCube,
      mask_cubem[0:2],
      SlicedLowLevelWCS(cubem.wcs, (slice(0, 2, None), slice(None, None, None), slice(None, None, None))),
      data[0:2],
      u.Quantity((2, 3, 4), unit=u.pix),
      ('custom:pos.helioprojective.lon', 'custom:pos.helioprojective.lat', 'em.wl'),
     ...
     (cube[1],
      NDCube,
      mask_cube[1],
      SlicedLowLevelWCS(cube.wcs, (1, slice(None, None, None), slice(None, None, None), slice(None, None, None))),
      uncertainty[1],
      u.Quantity((2, 3, 4), unit=u.pix),
      ('em.wl', 'time'),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[0:2],
      NDCube,
      mask_cube[0:2],
      SlicedLowLevelWCS(cube.wcs, (slice(0, 2, None), slice(None, None, None), slice(None, None, None), slice(None, None, None))),
      uncertainty[0:2],
...
@pytest.mark.parametrize(
    ...
    #   NDCube,
    #   mask_cubem[:, :, 1],
    #   SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), slice(None, None, None), 1)),
    #   data[:, :, 1],
    ...
    #   ),
     (cubem[:, :, 0:2],
      NDCube,
      mask_cubem[:, :, 0:2],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), slice(None, None, None), slice(0, 2, None))),
      data[:, :, 0:2],
     ...
     (cubem[:, 1, 1],
      NDCube,
      mask_cubem[:, 1, 1],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), 1, 1)),
      data[:, 1, 1],
     ...
     (cubem[:, 1, 0:2],
      NDCube,
      mask_cubem[:, 1, 0:2],
      SlicedLowLevelWCS(cubem.wcs, (slice(None, None, None), 1, slice(0, 2, None))),
      data[:, 1, 0:2],
     ...
     (cubem[1, :, 1],
      NDCube,
      mask_cubem[1, :, 1],
      SlicedLowLevelWCS(cubem.wcs, (1, slice(None, None, None), 1)),
      data[1, :, 1],
     ...
     (cubem[1, :, 0:2],
      NDCube,
      mask_cubem[1, :, 0:2],
      SlicedLowLevelWCS(cubem.wcs, (1, slice(None, None, None), slice(0, 2, None))),
      data[1, :, 0:2],
    ...
    # Not working in my computer, need to be checked!
     ...
     (cube[:, :, 1],
      NDCube,
      mask_cube[:, :, 1],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), slice(None, None, None), 1, slice(None, None, None))),
      uncertainty[:, :, 1],
     ...
     (cube[:, :, 0:2],
      NDCube,
      mask_cube[:, :, 0:2],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), slice(None, None, None), slice(0, 2, None), slice(None, None, None))),
      uncertainty[:, :, 0:2],
     ...
     (cube[:, 1, 1],
      NDCube,
      mask_cube[:, 1, 1],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), 1, 1, slice(None, None, None))),
      uncertainty[:, 1, 1],
     ...
     (cube[:, 1, 0:2],
      NDCube,
      mask_cube[:, 1, 0:2],
      SlicedLowLevelWCS(cube.wcs, (slice(None, None, None), 1, slice(0, 2, None), slice(None, None, None))),
      uncertainty[:, 1, 0:2],
      u.Quantity((5, 2, 4), unit=u.pix),
      ('custom:pos.helioprojective.lat', 'time'),
      {'time': {'axis': 0, 'value': u.Quantity(range(int(cube.dimensions[0].value)), unit=u.pix)},
     ...
     (cube[1, :, 1],
      NDCube,
      mask_cube[1, :, 1],
      SlicedLowLevelWCS(cube.wcs, (1, slice(None, None, None), 1, slice(None, None, None))),
      uncertainty[1, :, 1],
      u.Quantity((2, 4), unit=u.pix),
      tuple(['em.wl']),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, :, 0:2],
      NDCube,
      mask_cube[1, :, 0:2],
      SlicedLowLevelWCS(cube.wcs, (1, slice(None, None, None), slice(0, 2, None), slice(None, None, None))),
      uncertainty[1, :, 0:2],
      u.Quantity((2, 2, 4), unit=u.pix),
      ('em.wl', 'time'),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 1, 1],
      NDCube,
      mask_cube[1, 1, 1],
      SlicedLowLevelWCS(cube.wcs, (1, 1, 1, slice(None, None, None))),
      uncertainty[1, 1, 1],
      u.Quantity((), unit=u.pix),
      (),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
     ...
     (cube[1, 1, 0:2],
      NDCube,
      mask_cube[1, 1, 0:2],
      SlicedLowLevelWCS(cube.wcs, (1, 1, slice(0, 2, None), slice(None, None, None))),
      uncertainty[1, 1, 0:2],
      u.Quantity((2, 4), unit=u.pix),
      tuple(['time']),
      {'time': {'axis': None, 'value': u.Quantity(1, unit=u.pix)},
