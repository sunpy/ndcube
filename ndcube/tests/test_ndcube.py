...
def test_bounding_box_to_points(ndcube_2d_ln_lt):
    cube = ndcube_2d_ln_lt  # As bounding_box_to_points is a method, we need any cube.
    # Define inputs.
    ...
    expected_corners = (('low', 'low', 'low', 'low'),
                        ...
                        ('high', 'high', 'low', 'low'),
                        ('high', 'high', 'high', 'high'))
    output_corners = cube._bounding_box_to_points(lower_corner_values, upper_corner_values,
